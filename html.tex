...
\subsection{Soron belüli formázások}
...
\begin{frame}
  ...
  \vfill
  \begin{description}[m]
    \item[<small>] \hfill \\ Kisbetűs szöveg. (A <big> elem a HTML5-ben már nem támogatott.)
    \item[<i>] (italics) \hfill \\ Döntötten szedett szöveg, jelentéstöbblet nélkül.
    \item[<em>] (emphasized) \hfill \\ Hangsúlyos, fontos szövegrész, melyet a böngésző alapértelmezetten általában dőlt betűkkel jelenít meg.
  \end{description}
\end{frame}
...
\begin{frame}
  \begin{description}[m]
    \item[<b>] (bold) \hfill \\ Félkövéren szedett szöveg, jelentéstöbblet nélkül.
    \item[<strong>] (strong importance) \hfill \\ Kiemelten hangsúlyos, fontos szövegrész, melyet a böngésző alapértelmezetten általában félkövér betűkkel jelenít meg.
    \item[<sup>] (superscript) \hfill \\ Felső index.
    \item[<sub>] (subscript) \hfill \\ Alsó index.
    \item[<ins>] (inserted) \hfill \\ Utólag beszúrt szöveg (ált. aláhúzással jelölve).
    \item[<del>] (deleted) \hfill \\ Kitörölt szöveg (ált. áthúzással jelölve).
  \end{description}
\end{frame}
