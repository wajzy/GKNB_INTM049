...
% alapértelmezett paraméter érték, érték és ref. szerinti param. átadás
% többi alaptípus, typeof eredménye, metódusok, immutable
% JSON, Date
% a let, const, var, function ismertetése után valahová beszúrni, hogy let/const esetén a változó felüldefiniálására figyelveztet, var/function esetén viszont nem.
