...
\begin{frame}
  \begin{exampleblock}{\textattachfile{objektumok.js}{Metódus hozzáadása literálként}}
    \lstinputlisting[language=JavaScript,numbers=left,linerange=72-81,firstnumber=72]{objektumok.js}
  \end{exampleblock}
\end{frame}
...
\begin{frame}
  ...
  \begin{exampleblock}{\textattachfile{tombok.js}{Rendezés különféle sorrendekbe}}
    \vspace{-0.3cm}
    \lstinputlisting[language=JavaScript,numbers=left,linerange=95-97,firstnumber=95]{tombok.js}
    \vspace{-0.3cm}
  \end{exampleblock}
\end{frame}
...
\begin{frame}
  ...
  \begin{exampleblock}{\textattachfile{tombok.js}{Tömb fv. paramétert váró függvényei}}
    \vspace{-0.3cm}
    \lstinputlisting[language=JavaScript,numbers=left,linerange=99-105,firstnumber=99]{tombok.js}
    \vspace{-0.3cm}
  \end{exampleblock}
\end{frame}
...
\begin{frame}
  \begin{exampleblock}{\textattachfile{kompozicio.js}{Kompozíció:} függvények összefűzése, az egyik visszatérési értéke objektum, aminek szintén hívható egy függvénye}
      \footnotesize
