  ...
  \begin{columns}[c]
    \column{0.76\textwidth}
      \begin{exampleblock}{\textattachfile{fontawesome.html}{fontawesome.html}}
        \scriptsize
        \lstinputlisting[style=HTML,linerange={6-10},numbers=left,firstnumber=6]{fontawesome.html}
        \lstinputlisting[style=HTML,linerange={13-21},numbers=left,firstnumber=13]{fontawesome.html}
      \end{exampleblock}
    \column{0.2\textwidth}
